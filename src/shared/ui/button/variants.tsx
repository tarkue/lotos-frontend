...
export const buttonVariants = cva(
  "flex justify-center items-center gap-2 transition-colors duration-300 cursor-pointer font-roboto font-medium disabled:cursor-not-allowed truncate",
  {
    variants: {
      variant: {
        primary:
